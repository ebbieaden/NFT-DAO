...
contract CryptoDevsDAO is Ownable {
    ...
    //numbers of proposals that have been created
        ...
        returns (uint256)
    {
        ...
        //Set the proposal's votind deadline to be (current time + 5 minuutes)
    ...
    // if the given proposal's deadline has not been exceeded yet
    ...
    /// @dev voteOnProposal allows a CryptoDevsNFt holder to cast their vote active proposal
        ...
        inactiveProposalOnly(proposalIndex)
    {
        ...
        // purchase the NFT from the  FakeNFMarketplace
